...
/**
 * Question controller for Faqs Component.
 *
 * @package     Faqs
 * @subpackage  com_faqs
 * @author      Bruno Batista <bruno.batista@ctis.com.br>
...
class FaqsControllerQuestion extends JControllerForm
{
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		$user     = JFactory::getUser();
		$userId   = $user->get('id');
		$asset    = 'com_faqs.question.' . $recordId;
	 ...
	 * @since   3.2
	 */
	public function getModel($name = 'Form', $prefix = 'FaqsModel', $config = array('ignore_request' => true))
	{
