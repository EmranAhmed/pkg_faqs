...
class FaqsModelFeatured extends FaqsModelQuestions
{
	...
	protected function getListQuery($resolveFKs = true)
	{
		...
		$query->select('fp.ordering')
			->join('INNER', '#__faqs_frontpage AS fp ON fp.question_id = a.id');
		...
		$query->order($db->escape($this->getState('list.ordering', 'a.question')) . ' ' . $db->escape($this->getState('list.direction', 'ASC')));
